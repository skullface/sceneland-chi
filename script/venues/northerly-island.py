...
page = session.get('https://www.livenation.com/venue/KovZpZAEA7IA/huntington-bank-pavilion-at-northerly-island-events', headers={'User-Agent': 'Mozilla/5.0'})
