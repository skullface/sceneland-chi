...
page = session.get('https://www.livenation.com/venue/KovZpZAEktFA/credit-union-1-amphitheatre-events', headers={'User-Agent': 'Mozilla/5.0'})
...
for show in shows:
  ...
  if '2024 Season Tickets' not in artist:
    ...
    all_shows_data['venue'] = 'Tinley Park Amphitheatre'
