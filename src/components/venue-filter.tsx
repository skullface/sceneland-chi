...
export function VenueFilter({
  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content className='dropdown-content mx-auto grid grid-cols-2 flex-col rounded-xl bg-zinc-900 shadow-lg shadow-black/5 dark:bg-zinc-50 max-md:w-[95%] max-md:pt-2 md:min-w-[360px]'>
          {venues
              ...
              (venue) =>
                venue && (
                  <DropdownMenu.CheckboxItem
                    className='dropdown-item flex cursor-pointer justify-start gap-x-2 px-4 py-2 font-medium text-zinc-100 hover:bg-zinc-800 hover:text-white focus:bg-zinc-800 focus:text-white focus:outline-none dark:text-zinc-800 dark:hover:bg-zinc-200 dark:hover:text-zinc-950 dark:focus:bg-zinc-200 dark:focus:text-zinc-950 max-md:text-sm md:items-center md:first-of-type:rounded-tl-xl md:first-of-type:pt-3 md:[&:nth-of-type(2)]:rounded-tr-xl'
          ...
          <div className='col-span-2 mb-5 mt-3 grid grid-cols-2 gap-3 px-5'>
            <button
